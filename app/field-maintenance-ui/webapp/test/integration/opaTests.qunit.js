...
sap.ui.require(
  [
    ...
    "sap/ui/qunit/qunit-junit",
    "sap/ui/qunit/qunit-coverage",
    "utility/spareparts/fieldmaintenanceui/test/integration/FirstJourney",
    "utility/spareparts/fieldmaintenanceui/test/integration/SpareRequestsListJourney",
    "utility/spareparts/fieldmaintenanceui/test/integration/SpareRequestsObjectPageJourney",
], function (QUnit) {
    "use strict";
    QUnit.start();
});
